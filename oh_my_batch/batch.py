...
LOG_EXIT_CODE = '''>>>>>>>> AUTO-GENERATED BY oh-my-batch, DO NOT MODIFY <<<<<<<<
EXIT_CODE=$?
__script="${SLURM_SUBMIT_DIR:+$SLURM_SUBMIT_DIR/${SLURM_JOB_NAME}}"
__script="${__script:-${BASH_SOURCE[0]:-${(%):-%N}}}"
__script="${__script:-$0}"
__script_path="$(cd "$(dirname "$__script")" 2>/dev/null && pwd)/$(basename "$__script")"
echo $EXIT_CODE > "$__script_path.exitcode"
exit $EXIT_CODE
'''
